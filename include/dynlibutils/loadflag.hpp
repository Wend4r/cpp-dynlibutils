...
#ifndef DYNLIBUTILS_LOADFLAG_HPP
#define DYNLIBUTILS_LOADFLAG_HPP
#pragma once
...
namespace DynLibUtils
{
	 ...
	 */
	constexpr LoadFlag operator|(LoadFlag lhs, LoadFlag rhs) noexcept
	{
	 ...
	 */
	constexpr bool operator&(LoadFlag lhs, LoadFlag rhs) noexcept
	{
		using underlying = typename std::underlying_type<LoadFlag>::type;
...
#endif // DYNLIBUTILS_LOADFLAG_HPP